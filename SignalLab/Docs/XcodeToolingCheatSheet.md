...
**Debug** your app, then use the **Memory Graph** action (toolbar or **Debug** menu) to see **object graph** and **strong reference** paths. Search for a type name; expand **retaining paths** to see why an object is still alive.
